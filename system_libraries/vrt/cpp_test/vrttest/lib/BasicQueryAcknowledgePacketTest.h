...
#ifndef _BasicQueryAcknowledgePacketTest_h
#define _BasicQueryAcknowledgePacketTest_h
...
namespace vrttest {
  ...
  class BasicQueryAcknowledgePacketTest : public VRTObject, public virtual Testable {
    // Implement Testable
...
#endif /* _BasicQueryAcknowledgePacketTest_h */
