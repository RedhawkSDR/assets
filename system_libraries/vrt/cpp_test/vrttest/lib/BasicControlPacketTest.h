...
#ifndef _BasicControlPacketTest_h
#define _BasicControlPacketTest_h
...
namespace vrttest {
  ...
  class BasicControlPacketTest : public VRTObject, public virtual Testable {
    // Implement Testable
...
#endif /* _BasicControlPacketTest_h */
