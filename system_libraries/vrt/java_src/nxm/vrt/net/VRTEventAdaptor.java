...
/** A listener for VRT events that just prints errors and warnings to
 *  {@link System#err}. Any notifications of a received and/or sent packet are
 *  ignored unless debug is turned on; if debug is turned on, packets
 *  sent/received will be printed to {@link System#out}. <br>
 *  <br>
 *  Users are encouraged to extend this class and override the
 *  {@link #receivedPacket} and {@link #sentPacket} methods.
 */
public class VRTEventAdaptor implements VRTEventListener {
   ...
   *  @param debug Send debug output to {@link System#out}?
   */
