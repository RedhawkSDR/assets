...
public class QueueFullException extends RuntimeException {
   ...
   *  @return The object that "owns" the queue.
   */
  public Object getQueueOwner () {
    return owner;
  }

  /** Gets the number of packets discarded as a result of the queue being full.
   *  @return The number of packets discarded or -1 if unknown.
   */
