...
interface Type {
  ...
  static final Type BYTE     = new BasicType("byte",     true,  false,  1, "$0$",    "byte",                 "int8_t" );
  static final Type SHORT    = new BasicType("short",    true,  false,  2, "$0$",    "short",                "int16_t");
  static final Type INT      = new BasicType("int",      true,  false,  4, "$0$",    "int",                  "int32_t");
  static final Type LONG     = new BasicType("long",     true,  false,  8, "$0$",    "long",                 "int64_t");
  static final Type FLOAT    = new BasicType("float",    true,  false,  4, "$0.0$",  "float",                "float"  );
  static final Type DOUBLE   = new BasicType("double",   true,  false,  8, "$0.0$",  "double",               "double" );
  static final Type BOOLEAN  = new BasicType("boolean",  false, false,  1, null,     "boolean",              "bool"   );
  static final Type BOOLNULL = new BasicType("boolNull", false, false,  1, "$null$", "java.lang.Boolean",    "boolNull");
  static final Type INETADDR = new BasicType("inetAddr", false, true,  16, null,     "java.net.InetAddress", "InetAddress");
  static final Type UUID     = new BasicType("uuid",     false, true,  16, null,     "java.util.UUID",       "UUID");
  ...
  /** Is this an object type? For the purposes of this method,
   *  only those objects that would extend VRTObject in C++
   *  are considered to be an object type.
   */
  ...
  class PrecompiledType implements Type {
    ...
    @Override public boolean isObjectType ()   { return false; }
  ...
  class BasicType implements Type {
    ...
    BasicType (String name, boolean numeric, boolean object, int bytes,
               String defVal, String javaType, String cppType) {
      this(name, numeric, object, bytes, defVal, javaType, javaType, cppType, cppType);
    }

    BasicType (String name, boolean numeric, boolean object, int bytes,
               String defVal, String javaGet, String javaSet, String cppGet, String cppSet) {
      super();
      this.name    = name;
  ...
  static class TimeStampType extends BasicType {
    ...
    public TimeStampType (String name, TimeStamp.IntegerMode epoch, String defVal) {
      super(name, false, true, 12, defVal, "nxm.vrt.lib.TimeStamp", "TimeStamp");
      this.epoch = epoch;
    }
  }
