...
public interface ContextPacket extends VRTPacket, HasStateEventBits {
  ...
  public static abstract class AbstractGeolocation extends Record {
    ...
    protected void setTimeStamp (TimeStamp ts) {
      ...
      if (ts.getFractionalMode() == FractionalMode.None) {
        ...
        packLong(8, ts.getTimeStampFractional());
      }
    }
  }
  ...
  public static final class ContextAssocLists extends Record {
     ...
     *  @return The number of <b>source</b> context associations.
     */
    public int getSourceContextCount () { return unpackShort(0) & 0x01FF; }


    /** Gets the number of <b>system</b> context associations.
     *  @return The number of <b>system</b> context associations.
     */
    public int getSystemContextCount () { return unpackShort(2) & 0x01FF; }

    /** Gets the number of <b>vector-component</b> context associations.
     *  @return The number of <b>vector-component</b> context associations.
     */
    public int getVectorComponentCount () { return unpackShort(4) & 0xFFFF; }

    /** Gets the number of <b>asynchronous-channel</b> context associations. Note that this counts
     *  only the number of associations (i.e. counts an association with a tag as 1 not 2).
     *  @return The number of <b>asynchronous-channel</b> context associations.
     */
    public int getAsynchronousChannelCount () { return unpackShort(6) & 0x7FFF; }

    /** Are the <b>asynchronous-channel</b> context associations accompanied by
     *  <b>asynchronous-channel Tags</b>? If they are present, the number of them will match the
     *  number of asynchronous-channel associations (see {@link #getAsynchronousChannelCount}).
     *  @return true if the tags are present, false otherwise.
     */
     ...
     *  @param val The number of associations. If this is less than are currently present, only the
     *             first ones will be retained.
     */
    ...
    /** Are the <b>asynchronous-channel</b> context associations accompanied by
     *  <b>asynchronous-channel Tags</b>?
     *  @param val true if present, false if not. Setting this to false will discard any current
    ...
    private void checkUniqueIDs (int[] ids) {
      HashSet<Integer> idList = new HashSet<>(ids.length);
      for (int id : ids) {
