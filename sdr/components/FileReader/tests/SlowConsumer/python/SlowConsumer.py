...
# AUTO-GENERATED
#
# Source: SlowConsumer.spd.xml
from ossie.resource import start_component
import logging

from SlowConsumer_base import *

class SlowConsumer_i(SlowConsumer_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", SlowConsumer_i.MyMsg, self.msg_callback)
...
if __name__ == '__main__':
    ...
    start_component(SlowConsumer_i)
