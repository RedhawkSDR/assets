 ...
 *
 * This file is part of REDHAWK sourcesocket.
 *
 * REDHAWK sourcesocket is free software: you can redistribute it and/or modify it
 * under the terms of the GNU Lesser General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or (at your
 * option) any later version.
 *
 * REDHAWK sourcesocket is distributed in the hope that it will be useful, but WITHOUT
