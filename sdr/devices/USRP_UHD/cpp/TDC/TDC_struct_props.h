#ifndef TDC_STRUCTPROPS_H
#define TDC_STRUCTPROPS_H
...
inline bool operator>>= (const CORBA::Any& a, TDC_ns::device_characteristics_struct& s) {
    CF::Properties* temp;
...
inline void operator<<= (CORBA::Any& a, const TDC_ns::device_characteristics_struct& s) {
...
inline bool operator== (const TDC_ns::device_characteristics_struct& s1, const TDC_ns::device_characteristics_struct& s2) {
...
inline bool operator>>= (const CORBA::Any& a, TDC_ns::frontend_tuner_status_struct_struct& s) {
    CF::Properties* temp;
    if (!(a >>= temp)) return false;
    const redhawk::PropertyMap& props = redhawk::PropertyMap::cast(*temp);
...
inline void operator<<= (CORBA::Any& a, const TDC_ns::frontend_tuner_status_struct_struct& s) {
    redhawk::PropertyMap props;
...
inline bool operator== (const TDC_ns::frontend_tuner_status_struct_struct& s1, const TDC_ns::frontend_tuner_status_struct_struct& s2) {
