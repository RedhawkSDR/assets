...
// ----------------------------------------------------------------------------------------
CF_DeviceStatus_Out_i::CF_DeviceStatus_Out_i(std::string port_name, FmRdsSimulator_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<FmRdsSimulator_i *> (_parent);
