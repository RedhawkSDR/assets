...
class Field extends Definition {
  ...
  Field (Record r, Node node, int off) {
    super();
    record     = r;
...
//  }
  ...
  public void writeHTML (PacketGen outParams, PrintStream html, PrintStream index, String fileName) {
    String typeStr = type; // may change, see commented-out code above
  ...
  private static class CodeParams {
    ...
    CodeParams (String html, String size, String limit, String lenGet, String lenSet) {
      this.html   = html;
      this.size   = size;
      this.limit  = limit;
      this.lenGet = lenGet;
