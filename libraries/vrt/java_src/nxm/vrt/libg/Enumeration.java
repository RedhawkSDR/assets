...
class Enumeration implements Type {
   ...
   */
  Enumeration (PacketType pt, Node node) {
    super();
    NodeList _values;
    packetType = pt;
    ...
    type       = "byte";
    values     = new ArrayList<EnumValue>(_values.getLength());
  ...
  public void writeHTML (PacketGen outParams, PrintStream html, PrintStream index, String fileName) {
    ...
    for (EnumValue v : values) {
      StringBuilder names = new StringBuilder(8192);
      names.append(v.name);
  ...
  static class EnumValue {
    ...
    EnumValue (Enumeration e, Node node) {
      enumeration = e;
