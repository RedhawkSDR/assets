...
public abstract class AbstractVRAFile implements VRAFile, PacketIterator.PacketContainer {
  ...
  public byte[] getNextPacketBuffer (PacketIterator pi) {
    throw new UnsupportedOperationException("nextBuffer() not supported");
  }
   ...
   *  @return The file length in octets or -1 if unknown.
   */
