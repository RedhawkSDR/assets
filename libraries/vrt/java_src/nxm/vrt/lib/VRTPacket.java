...
public interface VRTPacket {
   ...
   *  @return The content of the packet. The array length will match the packet length.
   *  @see #readPacket(byte[])
   */
  byte[] getPacket ();
  ...
  /** Gets the content of the packet payload. <br>
   *  <br>
   *  <b>NOTE: This provides the content of the payload portion of the packet in "raw" form. Most
   *  users will want to avoid this function and use the functions appropriate to the specific
   *  packet type.</b>
   *  @return The content of the payload. The array length will match the payload length.
  ...
  public static enum PacketType {
     ...
     *  @return true if the packet type has a stream identifier, false if it is "unidentified"
     *          (i.e. lacks a stream identifier).
     */
     ...
     *  @return true for any IF Data or Extension Data packet, false otherwise.
     */
    public boolean isData () { return (ordinal() <= 3); }

    /** Is this type supported?
     *  @return true for any supported packet type, false otherwise.
     */
  ...
  public static enum RealComplexType {
    ...
    /** Is this type supported?
     *  @return true for all defined types, false for any bit patterns "reserved for future use".
     */
    public boolean isSupported () { return supported; }
  }
  ...
  public static enum DataItemFormat {
    ...
    /** Is this type supported?
     *  @return true for all defined formate, false for any bit patterns "reserved for future use".
     */
    public boolean isSupported () { return supported; }

    /** Is this a signed number?
     *  @return true if the type represents a signed number (integer, IEEE-754 or VRT) and false
     *          if it represents an unsigned number (integer or VRT).
     */
  ...
  public static enum DataType {
    ...
    /** <b>Internal use only:</b> Gets the associated bits. <br>
     *  <br>
     *  <b>NOTE: This does NOT return the bit-width of the type.</b>
     *  @return The internal bit pattern associated with the type within a {@link StandardDataPacket}.
     */
   ...
   *  </pre>
   */
  public static class PayloadFormat implements HasFields, Cloneable {
    ...
    public PayloadFormat clone () {
      try {
        return (PayloadFormat)super.clone();
      }
    ...
    /** <i>Internal Use Only:</i> Gets the bits. <br>
     *  <br>
     *  <b>NOTE: This does NOT return the bit-width of the format.</b>
     *  @return The internal bit pattern associated with the format in a {@link ContextPacket}.
     */
    public long getBits () {
      return (((long)hi) << 32) | (lo & 0xFFFFFFFFL);
    }

    /** <i>Internal Use Only:</i> Sets the bits. <br>
     *  <br>
     *  <b>NOTE: This does NOT return the bit-width of the format.</b>
     *  @param bits The internal bit pattern associated with the format in a {@link ContextPacket}.
     */
