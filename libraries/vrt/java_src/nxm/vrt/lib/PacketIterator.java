...
public final class PacketIterator implements Iterator<VRTPacket>, Enumeration<VRTPacket> {
  ...
  /** <b>Internal Use Only:</b> Gets a buffer containing the content for the
   *  next packet. This is used to iterating over the container in a situation
   *  where creating packet objects needs to be avoided.
   *  @return The next buffer, as applicable.
   *  @throws UnsupportedOperationException If this function is unsupported.
   */
  public final byte[] nextBuffer () {
    return container.getNextPacketBuffer(this);
  }
  ...
  public static interface PacketContainer extends Iterable<VRTPacket> {
     ...
     *  @throws UnsupportedOperationException If this function is unsupported.
     */
    byte[] getNextPacketBuffer (PacketIterator pi);
