...
public class BasicContextPacket extends BasicVRTPacket implements VRTPacket, ContextPacket {
   ...
   */
  public BasicContextPacket (VRTPacket p, boolean copy) {
    super(p, copy);
  ...
  @Override public final Ephemeris         getEphemerisECEF ()            { return getRecord(ECEF_EPHEM  , new Ephemeris()        ); }
  @Override public final Ephemeris         getEphemerisRelative ()        { return getRecord(REL_EPHEM   , new Ephemeris()        ); }
  ...
  @Override public final Float             getGain1 ()                    { Short bits = getI(GAIN       ,2); return (bits == null)? null : toFloat16 ( 7,bits); }
  @Override public final Float             getGain2 ()                    { Short bits = getI(GAIN       ,0); return (bits == null)? null : toFloat16 ( 7,bits); }
  ...
  @Override public void setEphemerisECEF (Ephemeris val)             { setRecord(ECEF_EPHEM  , val); }
  @Override public void setEphemerisRelative (Ephemeris val)         { setRecord(REL_EPHEM   , val); }
  ...
  @Override public void setGain1 (float val)                         { Short bits =                       fromFloat16 ( 7,val);     setI(GAIN       ,2,bits); }
  @Override public void setGain2 (float val)                         { Short bits =                       fromFloat16 ( 7,val);     setI(GAIN       ,0,bits); }
  ...
  public final Long getOverRangeCount () {
    ...
    return (bits == null)? null : (bits & 0xFFFFFFFFL);
  }
  ...
  private <T extends Record> void setRecord (int bit, T val, int oldLen) {
    ...
    int newLen = (val == null)? 0 : val.getByteLength();
