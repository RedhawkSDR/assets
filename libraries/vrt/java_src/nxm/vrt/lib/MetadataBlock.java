...
/** <b>Internal Use Only (Experimental):</b> Class to support the Binary Metadata
 *  Language. Each entry has three pieces of information:
 *  <ul>
...
public final class MetadataBlock implements Iterable<MetadataBlock.MetadataEntry> {
  ...
  public MetadataBlock () {
    this.entries = new ArrayList<MetadataEntry>(16);
  }

  /** Creates a new instance with the given entries.
   *  @param entries The initial entries to include.
   */
  ...
  public String toString () {
    StringBuilder str = new StringBuilder(entries.size() * 32);
   ...
   *  @return The length of the block in octets.
   */
  public int getLengthInBytes () {
    return writeBytes(EMPTY_BUF, 0, 0);
  }

  /** Gets a reference to the entries in the metadata block.
   *  @return A reference to the entries in the metadata block.
   */
  public List<MetadataEntry> getEntries () {
    return entries;
  }

  /** Sets the reference to the entries in the metadata block.
   *  @param entries A reference to the entries in the metadata block.
   */
  ...
  public void readBytes (byte[] buf, int off, int len, boolean keepNull) {
    List<MetadataEntry> list = new ArrayList<MetadataEntry>(16);
  ...
  public final static class MetadataEntry {
    ...
    /** Prints the entry in string form.
     *  @return A free-form string describing the entry.
     */
    @Override
    public String toString () {
     ...
     *  @return The level of the entry (0..4095).
     */
    public int getLevel () {
      return level;
    }
     ...
     *  @param level The level of the entry (0..4095).
     */
    ...
    /** Sets the value.
     *  @param val The value as a string (max length is 32767 octets when packed as UTF-8).
     *  @throws IllegalArgumentException If the length exceeds 32767 octets.
     */
