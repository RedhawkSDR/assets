...
#ifndef _NetUtilitiesTest_h
#define _NetUtilitiesTest_h
...
namespace vrttest {
  ...
  class NetUtilitiesTest : public VRTObject, public virtual Testable {
    // Implement Testable
    ...
    public: virtual void testGetNetworkDeviceName ();
  };
} END_NAMESPACE
#endif /* _NetUtilitiesTest_h */
